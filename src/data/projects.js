const projects = [
  {
    ...
    filename: "electricity_monitor.json",
    screenshot: "../../public/photo.png",
    liveLink: "https://example.com/electricity-monitor",
    githubLink: "https://github.com/arghyadeep00/Smart-Switch-Control.git",
    description:
      "A real-time electricity monitoring system using IoT and MERN stack. Allows users to track power usage, control switches remotely, and receive analytics to optimize consumption.",
  },
  {
    id: 2,
    title: "Tic-Tac-Toe",
